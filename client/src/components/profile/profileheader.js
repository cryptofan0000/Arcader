            ...
            <div className='profile-header-section'>
                ...
                <div className='profile-info-section'>
                    <div className='social-profile'>
                        <a href='#'><img src={IMG_STREAM_ICO} alt='icon' className='profile-social-links' /></a>
                        <a href='#'><img src={IMG_FORTUN_ICO} alt='icon' className='profile-social-links' /></a>
                        <a href='#'><img src={IMG_BATTLE_ICO} alt='icon' className='profile-social-links' /></a>
                    </div>
                    <div className='profile-info'>
                        <div className='profile-name-section'>
                            <img src={RESOURCE_URL + 'flags/flag-' + headerData.country + '.svg'} alt={headerData.country} />
                    ...
                    <div className='social-profile'>
                        <a href='#'><img src={IMG_TELEGR_ICO} alt='icon' className='profile-social-links' /></a>
                        <a href='#'><img src={IMG_INSTAG_ICO} alt='icon' className='profile-social-links' /></a>
                        <a href='#'><img src={IMG_YOUTUB_ICO} alt='icon' className='profile-social-links' /></a>
                    </div>
                </div>
