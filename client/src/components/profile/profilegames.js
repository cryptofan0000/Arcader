        ...
        <Fragment>
            <div className='profile-games-section'>
                <div className='profile-game-card ft-game-card'>
                    <img src={RESOURCE_URL + 'profile/profile-ft.png'} className='profile-game-card-bg' />
                ...
                <div className='profile-game-card co-game-card' >
                    <img src={RESOURCE_URL + 'profile/profile-co.png'} className='profile-game-card-bg' />
                    <div className='logo-section'>
                ...
                <div className='profile-game-card cs-game-card'>
                    <img src={RESOURCE_URL + 'profile/profile-cs.png'} className='profile-game-card-bg' />
                    <div className='logo-section'>
