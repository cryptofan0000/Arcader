            ...
            <div className='profile-edit-section'>
                ...
                <div className='edit-sub-section'>
                    ...
                    <div className='edit-account-inputs'>
                        ...
                        <div className='edist-pass-text'>
                            Create a password with at least 6 characters. Only Latin letters, numbers and general punctuation symbols are allowed. <br />
                            Let it be complex and original. We do not recommend using passwords from other sites and accounts.
                        </div>
                        <div className='edit-input-row'>
                            <AuthInput
                                value={usernewpass}
                ...
                <div className='edit-sub-section'>
                    ...
                    <div className='edit-socail-actions'>
                        <div className='edit-social-text'>Indicate your social networks so that the whole world is aware of your affairs and hello to everyone</div>
                        ...
                        <div className='edit-toogle'>
                            <ToggleInput
                                label={'Display this information on my profile'}
                            />
                        </div>
                    </div>
                </div>
